...
const data = [
	{
		name: 'Название, ID',
		cols: [
			{name: 'Столбец 1', isChecked: true},
			{name: 'Столбец 2', isChecked: true},
			{name: 'Столбец 3', isChecked: true},
		],
	},
	{
		name: 'Название, ID2',
	...
	return (
        ...
        `}>
			...
			<Row width="560px" className="">
				<Col
					width="279px"
					className="border-r border-[#333333] h-[648px] overflow-y-auto overflow-x-hidden">
					{data.map((item, index) => (
						<div id={`data-item-cols-${index}`}>
							<Row
								width="279px"
								onClick={() => {
									const cols = document.getElementById(
										`data-item-cols-${index}-col`,
									)
									if (cols) {
										//is hidden
							...
							<div style={{display: 'none'}} id={`data-item-cols-${index}-col`}>
