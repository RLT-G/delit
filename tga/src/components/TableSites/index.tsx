						...
						<>
								...
								<tl.HeaderRow className="bg-[#262626] color-[#808080] h-[36px] rounded-[10px]">
									...
									<tl.HeaderCell
										...
										<button
											...
											<p className={s.sortText}>Статус. сайта</p>
									...
									<tl.HeaderCell
										...
										<button
											...
											<p className={s.sortText}>Счетчик</p>
											<div className={s.headerCellSort_SVG}>
												<svg
													id="svg-icon-chevron-single-up-down"
													data-name="svg-icon-chevron-single-up-down"
									...
									<tl.HeaderCell
										...
										<button
											...
											<p className={s.sortText}>Компании</p>
											<div>
												<svg
													id="svg-icon-chevron-single-up-down"
													data-name="svg-icon-chevron-single-up-down"
									...
									<tl.HeaderCell
										...
										<button
											...
											<p className={s.sortText}>Доступ к реклам.</p>
											<div className={s.headerCellSort_SVG}>
												<svg
													id="svg-icon-chevron-single-up-down"
													data-name="svg-icon-chevron-single-up-down"
							...
							<tl.Body id="mainTable" style={{overflow: 'overlay'}}>
								{tableList.map((item: any) => (
									<tl.Row className="CheckBox" key={item.id} item={item}>
										...
										<tl.Cell>
											<Clicks className={s.Clicks} count={item.companyStatus} />
										</tl.Cell>
										<tl.Cell>
											<Col width="auto">
												<p id={item.counter === 'Подключён' ? 'green' : ''}>
													{item.counter}
												</p>
										...
										<tl.Cell>
											<Row width="auto" className={s.RowAccountAvatars}>
												<mui.Select
													...
													<Col
														width="280px"
														className={`cursor-pointer ${s.userBlock}`}>
														{users.map((user: IUser) => (
															<mui.Option
																key={user.id}
																className={`cursor-pointer z-10 ${s.itemUserText}`}
																value={user.id}>
																<AccountAvatar
																	img={user.avatar}
